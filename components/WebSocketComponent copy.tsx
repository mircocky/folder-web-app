...
const WebSocketComponent: React.FC = () => {
  ...
  useEffect(() => {
    ...
    socket.on('privateMessage', (data: { username_from: string; message_for_web: object }) => {
        ...
        const notificationMessage:object = {
          ...
          job_id : data.message_for_web?.job_id,
          vessel : data.message_for_web?.vessel,
          ETD : data.message_for_web?.ETD,
          ETA : data.message_for_web?.ETA
        }
  ...
  return (
    <div>
      ...
      Updated Live - updated on {message?.currentTime}
      </h1>        
